                  ...
                  <div class="col-span-1 sm:col-span-1">
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm" v-if="pops.length !== 0">
                      <multiselect deselect-label="Selected already" :options="pops" track-by="id" label="site_name"
                        v-model="form.pop_id" :allow-empty="false" :disabled="checkPerm('sn_id')" @select="POPSelect">
                      </multiselect>
                    </div>
                  </div>
                  <div class="col-span-1 sm:col-span-1">
...
export default {
  ...
  setup(props) {
    ...
    return { form, submit, resetForm, isNumber, checkPerm, res_sn, res_dn, DNSelect, goID, fillPppoe, pppoe_auto, generatePassword, POPSelect, OLTSelect, res_packages, isEmptyObject, pop_devices };
  },
};
</script>
<style>
