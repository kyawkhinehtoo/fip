    ...
    setup(props){
      ...
      const form = reactive({
        ...
        function submit() {
           if(! editMode.value){
            ...
            onError: (errors) => {
                ...
                Inertia.post('/township/' + form.id, form,{
                onSuccess: (page) => {
                closeModal()
                resetForm()
                Toast.fire(
        ...
        function deleteRow(data) {
                ...
                data._method = 'DELETE';
                Inertia.post('/township/' + data.id, data)
                closeModal()
                resetForm()
        }
        function openModal() {
        ...
        const searchTsp = () =>{
          ...
          Inertia.get('/township/', {township : search.value}, { preserveState: true })
        }
